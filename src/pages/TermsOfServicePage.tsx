export function TermsOfServicePage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      />
      <div className="tos-content" data-custom-class="body">
        <div style={{ textAlign: "left" }}>
          ...
          <div data-custom-class="subtitle" style={{ lineHeight: 1.5 }}>
            <strong>Last updated</strong> <strong>February 27, 2026</strong>
          </div>
          <br />
          <br />
        ...
        <div style={{ textAlign: "left" }}>
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            (the "Site"), the mobile application Bram (the "App"), as well as any
          ...
          <br />
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            You can contact us by phone at 3052993544, email at{" "}
            <a
              href="mailto:bram0001@bramllc.app"
              target="_blank"
              rel="noopener noreferrer"
              data-custom-class="link"
            >
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            you, whether personally or on behalf of an entity ("you"), and Bram
            LLC., concerning your access to and use of the Services. You agree that
          ...
          {/* 1. OUR SERVICES */}
          <div data-custom-class="heading_1" id="services" style={{ lineHeight: 1.5 }}>
          ...
          {/* 3. USER REPRESENTATIONS */}
          <div data-custom-class="heading_1" id="userreps" style={{ lineHeight: 1.5 }}>
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            have the legal capacity and you agree to comply with these Legal Terms;
            (4) you are not under the age of 13; (5) you are not a minor in the
          ...
          {/* 4. USER REGISTRATION */}
          <div data-custom-class="heading_1" id="userreg" style={{ lineHeight: 1.5 }}>
          ...
          {/* 9. SERVICES MANAGEMENT */}
          <div data-custom-class="heading_1" id="sitemanage" style={{ lineHeight: 1.5 }}>
          ...
          {/* 10. PRIVACY POLICY */}
          <div data-custom-class="heading_1" id="ppyes" style={{ lineHeight: 1.5 }}>
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            Policy:{" "}
            <a
              href="https://www.iubenda.com/privacy-policy/65011295"
              target="_blank"
              rel="noopener noreferrer"
              data-custom-class="link"
            >
              <strong>https://www.iubenda.com/privacy-policy/65011295</strong>
            </a>
          ...
          {/* 11. DMCA */}
          <div data-custom-class="heading_1" id="dmca" style={{ lineHeight: 1.5 }}>
            <h2>
              11. DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY
            </h2>
          </div>
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            Services infringes your copyright, you should consider first contacting
            an attorney.
          </div>
          <br />
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            agent, or the law; and (6) a statement that the information in the
          ...
          {/* 12. TERM AND TERMINATION */}
          <div data-custom-class="heading_1" id="terms" style={{ lineHeight: 1.5 }}>
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            provided below) informally for at least __________ days before
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE PURCHASE
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            BY US OR VIA THE SERVICES. You hereby waive any rights or requirements
          ...
          {/* 22. SMS TEXT MESSAGING */}
          <div data-custom-class="heading_1" id="sms" style={{ lineHeight: 1.5 }}>
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            By opting into any Vonage text messaging program, you expressly consent
            to receive text messages (SMS) to your mobile number. Vonage text
            messages may include: marketing communications.
          </div>
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            your opt out. After this, you will no longer receive SMS messages from
            us. If you want to join again, please sign up as you did the first time
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            the specifics of your mobile plan. Carriers are not liable for delayed
            or undelivered messages. If you have any questions about your text plan
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            communications, please reply with the keyword HELP. You can also email
            us at{" "}
            <a
              href="mailto:bram0001@bramllc.app"
              target="_blank"
            ...
            or call at 3052993544. If you have any questions regarding privacy,
            ...
            <a
              ...
              data-custom-class="link"
            >
              https://www.iubenda.com/privacy-policy/65011295
            </a>
            .
          </div>
          <br />
          ...
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            <strong>Phone: 3052993544</strong>
          </div>
          <div data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            <strong>
              <a
